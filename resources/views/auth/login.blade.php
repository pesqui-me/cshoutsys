    ...
    <section class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-primary-50 py-12 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-extrabold text-gray-900 mb-2">Bon retour !</h1>
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
                ...
                <div class="relative mt-6">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="bg-white px-2 text-gray-500">Vous n'avez pas de compte ?</span>
                    </div>
                </div>

                <!-- Register Link -->
                <div class="mt-6">
                    <a href="{{ route('register') }}" class="w-full btn btn-secondary justify-center">
                        <svg class="mr-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
