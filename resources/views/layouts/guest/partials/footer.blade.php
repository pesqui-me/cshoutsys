        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-4">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="flex items-center gap-3">
                    <a href="#" class="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-800 text-gray-400 hover:bg-primary-600 hover:text-white transition-all duration-200">
                        ...
                        <ul class="space-y-3">
                            ...
                            <li>
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-sm text-green-400 font-medium">Support 24/7</span>
                                </div>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="space-y-3">
                            ...
                            <li>
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-sm text-green-400 font-medium">SSL Sécurisé</span>
                                </div>
                            </li>
                        </ul>
                    </div>
