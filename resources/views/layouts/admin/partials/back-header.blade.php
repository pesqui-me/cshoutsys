        ...
        <nav class="topbar-custom d-flex justify-content-between" id="topbar-custom">    
            ...
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">                        
                ...
                <li class="mx-2 welcome-text">
                    <h5 class="mb-0 fw-semibold text-truncate">Bonjour, Pesquidox!</h5>
            ...
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                <li class="hide-phone app-search">
                    <form role="search" action="#" method="get">
                        <input type="search" name="search" class="form-control top-search mb-0" placeholder="Rechercher...">
                ...
                <li class="dropdown topbar-item">
                    ...
                    <div class="dropdown-menu stop dropdown-menu-end dropdown-lg py-0">
                        ...
                        {{-- <div class="hidden sm:flex sm:items-center sm:ml-6"> --}}
                            <!-- Notifications -->
                            {{-- <x-notification-dropdown :unreadCount="auth()->user()->unreadNotifications()->count()" /> --}}
                        ...
                        <a href="" class="dropdown-item text-center text-dark fs-13 py-2">
                            Toutes les notifications <i class="fi-arrow-right"></i>
                        </a>
                    </div>
                </li>
                ...
                <li class="dropdown topbar-item">
                    <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="#" role="button"
                        aria-haspopup="false" aria-expanded="false" data-bs-offset="0,19">
                        <img src="{{ asset('assets/common/images/avatars/common-user-avatar.jpg') }}" alt="" class="thumb-md rounded">
                    </a>
                    <div class="dropdown-menu dropdown-menu-end py-0">
                        <div class="d-flex align-items-center dropdown-item py-2 bg-secondary-subtle">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('assets/common/images/avatars/common-user-avatar.jpg') }}" alt="" class="thumb-md rounded-circle">
                            </div>
                            <div class="flex-grow-1 ms-2 text-truncate align-self-center">
                                <h6 class="my-0 fw-medium text-dark fs-13">Pesquidox AKODAZOUN</h6>
                                <small class="text-muted mb-0">Super Administrateur</small>
                            </div><!--end media-body-->
                        </div>
                        <div class="dropdown-divider mt-0"></div>
                        <small class="text-muted px-2 pb-1 d-block">Détails de compte</small>
                        <a class="dropdown-item" href=""><i class="las la-user fs-18 me-1 align-text-bottom"></i> Profil</a>
                        <small class="text-muted px-2 py-1 d-block">Paramètres de compte</small>                        
                        <a class="dropdown-item" href=""><i class="las la-lock fs-18 me-1 align-text-bottom"></i> Sécurité</a>
                        <a class="dropdown-item" href=""><i class="las la-question-circle fs-18 me-1 align-text-bottom"></i> Centre d'aide</a>                     
                        <div class="dropdown-divider mb-0"></div>
                        <a class="dropdown-item text-danger" href=""><i class="las la-power-off fs-18 me-1 align-text-bottom"></i> Déconnexion</a>
                    </div>
                </li>
            </ul><!--end topbar-nav-->
        </nav>
